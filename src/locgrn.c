...
/* modified by YN */
  ...
  if(s==t) {
    if(rk==rl) { /* CisAjsNks */
      ...
      else return GreenFunc1(ri,rj,s,ip,eleIdx,eleCfg,eleNum,eleProjCnt,projCntNew, /* modified by YN */
      ...
      else return -GreenFunc1(rk,rj,s,ip,eleIdx,eleCfg,eleNum,eleProjCnt,projCntNew, /* modified by YN */
                              hiddenCfg1,hiddenCfgNew1,hiddenCfg2,hiddenCfgNew2, /* added by YN */
      ...
      else return GreenFunc1(ri,rl,s,ip,eleIdx,eleCfg,eleNum,eleProjCnt,projCntNew, /* modified by YN */
                             hiddenCfg1,hiddenCfgNew1,hiddenCfg2,hiddenCfgNew2, /* added by YN */
      ...
      if(eleNum[rsi]==0) return 0.0;
      else return GreenFunc1(rk,rl,s,ip,eleIdx,eleCfg,eleNum,eleProjCnt,projCntNew, /* modified by YN */
                             hiddenCfg1,hiddenCfgNew1,hiddenCfg2,hiddenCfgNew2, /* added by YN */
    ...
    if(rk==rl) { /* CisAjsNkt */
      ...
      if(eleNum[rsi]==0) return 0.0;
      else return GreenFunc1(rk,rl,t,ip,eleIdx,eleCfg,eleNum,eleProjCnt,projCntNew, /* modified by YN */
                             hiddenCfg1,hiddenCfgNew1,hiddenCfg2,hiddenCfgNew2, /* added by YN */
