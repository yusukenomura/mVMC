...
int NSROptConstShift;  /* the number of SR method steps with constant shift for diagonal elements */ /* added by YN */
int NSROptStaDelShift; /* the number of SR method steps with modified DSROptStaDel */ /* added by YN */
...
double DSROptStaDelShiftAmp;  /* SR stabiliaing factor (shifting DSROptStaDel) */  /* added by YN */
double DSROptConstShiftRatio; /* SR stabiliaing factor for diagonal element modification (constant shift) */ /* added by YN */
...
int NPhysMagField;       /* Total number of magnetic-field variabls in physical layers          */
...
/* added by YN */
double complex *PhysMagField;   /* magnetic field acting on physical layers (HiddenMagField=Para+NProj)  */ 
double complex *HiddenMagField; /* magnetic field acting on hidden neurons (HiddenMagField=PhysMagField+NPhysMagField)  */ 
double complex *HiddenPhysInt;  /* Interaction between hidden and physical variables (HiddenPhysInt=HiddenMagField+NHiddenMagField)*/ 
/* added by YN */
...
int    *SmatIdxtoParaIdx; /* mapping between S matrix and variational parameters */  /* added by YN */
